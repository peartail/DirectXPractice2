...
bool ShadowShaderClass::Render(ID3D11DeviceContext* context, int indexCnt, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX proj, D3DXMATRIX lightview, D3DXMATRIX lightproj, ID3D11ShaderResourceView* tex, ID3D11ShaderResourceView* depthtex, D3DXVECTOR3 lightpos, D3DXVECTOR4 ambient, D3DXVECTOR4 diffuse)
{
	bool result;

	result = SetShaderParameters(context, world, view, proj, lightview,lightproj, tex,depthtex, lightpos, ambient, diffuse);
...
bool ShadowShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFile, WCHAR* psFile)
{
	HRESULT result;
	ID3D10Blob* errormsg;
...
void ShadowShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMEssage, HWND hwnd, WCHAR* filename)
{
	char* compileError;
...
bool ShadowShaderClass::SetShaderParameters(ID3D11DeviceContext* context, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX proj, D3DXMATRIX lightview, D3DXMATRIX lightproj, ID3D11ShaderResourceView* tex, ID3D11ShaderResourceView* depthtex, D3DXVECTOR3 lightpos, D3DXVECTOR4 ambient, D3DXVECTOR4 diffuse)
{
	HRESULT result;
...
void ShadowShaderClass::RenderShader(ID3D11DeviceContext* context, int indexCnt)
{
