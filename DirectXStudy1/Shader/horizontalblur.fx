...
PInputT VS(VInputT i)
{
	...
	texSize = 1.f / screenWidth;

	o.texc1 = i.tex + float2(texSize * -4.0f, 0.f);
	o.texc2 = i.tex + float2(texSize * -3.0f, 0.f);
	o.texc3 = i.tex + float2(texSize * -2.0f, 0.f);
	o.texc4 = i.tex + float2(texSize * -1.0f, 0.f);
	o.texc5 = i.tex + float2(texSize * 0.0f, 0.f);
	o.texc6 = i.tex + float2(texSize * 1.0f, 0.f);
	o.texc7 = i.tex + float2(texSize * 2.0f, 0.f);
	o.texc8 = i.tex + float2(texSize * 3.0f, 0.f);
	o.texc9 = i.tex + float2(texSize * 4.0f, 0.f);
