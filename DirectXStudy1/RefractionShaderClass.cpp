...
void RefractionShaderClass::RotationYawPitchRoll(float y, float p, float r)
{
	yaw = y; pitch = p; roll = r;
}

void RefractionShaderClass::TranslationMatrix(float x, float y, float z)
{
...
void RefractionShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMEssage, HWND hwnd, WCHAR* filename)
{
	char* compileError;
...
void RefractionShaderClass::RenderShader(ID3D11DeviceContext* context, int indexCnt)
{
