...
bool UIClass::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, WCHAR* textureFilename, int bitmapWidth, int bitmapHegith,D3DXMATRIX baseview)
{
	bool result;
...
bool UIClass::Render(ID3D11DeviceContext* context, int posx, int posy)
{
	bool result;
...
bool UIClass::UpdateBuffers(ID3D11DeviceContext* context, int posx, int posy)
{
	float l, r, t, b;
	VertexType* vertices;
...
void UIClass::RenderBuffers(ID3D11DeviceContext* context)
{
	unsigned int stride;
	unsigned int offset;
...
D3DXMATRIX UIClass::GetBaseViewMatrix()
{
