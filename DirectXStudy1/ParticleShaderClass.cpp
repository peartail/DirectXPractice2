...
bool ParticleShaderClass::Render(ID3D11DeviceContext* context, int indexCount, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX proj,ID3D11ShaderResourceView* tex)
{
	bool result;

	result = SetShaderParameters(context, world, view, proj,tex);
	if (!result)
	{
		return false;
	}
...
bool ParticleShaderClass::SetShaderParameters(ID3D11DeviceContext* context, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX proj, ID3D11ShaderResourceView* tex)
{
	HRESULT result;
...
void ParticleShaderClass::RenderShader(ID3D11DeviceContext* context, int indexcnt)
{
